...
##7 segment display
set_property PACKAGE_PIN W7 [get_ports {io_seg[6]}]
	set_property IOSTANDARD LVCMOS33 [get_ports {io_seg[6]}]
set_property PACKAGE_PIN W6 [get_ports {io_seg[5]}]
	set_property IOSTANDARD LVCMOS33 [get_ports {io_seg[5]}]
set_property PACKAGE_PIN U8 [get_ports {io_seg[4]}]
...
set_property PACKAGE_PIN U5 [get_ports {io_seg[2]}]
	set_property IOSTANDARD LVCMOS33 [get_ports {io_seg[2]}]
set_property PACKAGE_PIN V5 [get_ports {io_seg[1]}]
	set_property IOSTANDARD LVCMOS33 [get_ports {io_seg[1]}]
set_property PACKAGE_PIN U7 [get_ports {io_seg[0]}]
...
set_property PACKAGE_PIN U2 [get_ports {io_seg_an[0]}]
	set_property IOSTANDARD LVCMOS33 [get_ports {io_seg_an[0]}]
set_property PACKAGE_PIN U4 [get_ports {io_seg_an[1]}]
	set_property IOSTANDARD LVCMOS33 [get_ports {io_seg_an[1]}]
set_property PACKAGE_PIN V4 [get_ports {io_seg_an[2]}]
	set_property IOSTANDARD LVCMOS33 [get_ports {io_seg_an[2]}]
set_property PACKAGE_PIN W4 [get_ports {io_seg_an[3]}]
	set_property IOSTANDARD LVCMOS33 [get_ports {io_seg_an[3]}]
