...
#
# project.tcl: Tcl script for re-creating project 'Vending_machine'
#
...
set files [list \
 [file normalize "${origin_dir}/../generated/vending_machine.v"] \
]
...
set obj [get_filesets sources_1]
set_property -name "top" -value "cmd7HelperVendingMachineTop" -objects $obj
